...
#'   \item{prcnt_white_not_latino}{Percent of the county that was white, but not Latinx, in 2016.}
...
#'   \item{poverty}{Not available.}
#'   \item{pop_chg15}{Net increase or decrease in the population of the county in 2016; i.e. is the county shrinking or growing.}
...
#'   \item{prcnt_GOP12}{Percent of the county that voted for the Republican presidential candidate, Mitt Romney, in 2012.}
#'   \item{prcnt_GOP16}{Percent of the county that voted for the Republican presidential candidate, Donald Trump, in 2016.}
#'   \item{prcnt_dem12}{Percent of the county that voted for the Democratic presidential candidate, Barack Obama, in 2012.}
#'   \item{prcnt_dem16}{Percent of the county that voted for the Democratic presidential candidate, Hillary Clinton, in 2012.}
#'   \item{total_vote}{Total voting population in the county in 2016.}
#'   \item{region}{Area of the country: midwest, northeast, south, west.}
#' }
#'
