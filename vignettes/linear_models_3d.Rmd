...
The [orange]{style="color: orange;"} marginal effects in the graphic represent the change in $x_1$, median income, as $x_2$ is held constant. The orange line traverses the range of median income. `add_marginals()` defaults to holding $x_2$, education, constant at the mean value for $x_2$. This is 51.2\%. Note that although the regression is weighted by county population, the mean value is not weighted, so 51.2\% does not represent the mean value of college attendance for the country in 2016.
