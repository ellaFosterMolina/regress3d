...
Multiple regressions create regression **surfaces**, which have as many dimensions as there are variables (both $x$ and $y$) in the multiple regression equation. Marginal effects are a direction in this surface, which can be visualized by a line in the surface. 
