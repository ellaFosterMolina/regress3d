...
Multiple regressions create regression **surfaces**, which have as many dimensions as there are explanatory and outcome variables in the multiple regression equation. Marginal effects are a direction in this surface and can be visualized by a line in the surface. 
