...
plot_ly( data = county_data,
  ...
  add_marginals(model = mymodel, ci = T, omit_x2 =T,
                x2_constant_val = 13,
                x1_direction_name = "Marginal effect of education<br>with % Black held constant at 13%") 
```
...
plot_ly( data = county_data,
  ...
  add_marginals(model = mymodel, ci = T, omit_x2 =T,
                x2_constant_val = 75,
                x1_direction_name = "Marginal effect of % Black<br>with education held constant at 75%") 
```
