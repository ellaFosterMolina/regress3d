...
one_var_model <- glm(median_income16 ~ any_college, 
               data = county_data, 
               family = "Gamma")

two_vars_model <- glm(median_income16 ~ prcnt_black +any_college, 
               data = county_data, 
               family = "Gamma")
...
stargazer(one_var_model, two_vars_model , type = 'html',
          ...
          dep.var.labels = "County median income",
          dep.var.caption = "",
          model.numbers          = FALSE, 
          notes="<span>&#42;</span> p<0.05",
          notes.append=F)
