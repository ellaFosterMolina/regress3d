...
* The standard errors in the simple regression estimated for $\text(college_2cat_num) == 0$  are different from those created in the multiple regression where $\text(college_2cat_num) == 0$.
* The estimated value of the effects in the multiple regression and the subsetted simple regressions are the same. 
