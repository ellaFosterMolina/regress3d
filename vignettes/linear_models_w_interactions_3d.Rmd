...
* Using __plotly__ functions and arguments, we add scatterpoints, a hovertemplate for each point, and better labels. We adjust the colors of the scatterpoints to emphasize the low ([black]{style="color: black;"}) and high ([blue]{style="color: blue;"}) values of the education variable.
